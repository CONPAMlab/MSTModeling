...
List_Name={'Item_Limit','Standard_Mixture','Equal_Precision','Slots_plus_Averaging',...
    ...
    'Signal_Detection','Pure_Guess', 'SignalDetection_ROC','Threshold_ROC','EVSD3','EVSD3_LDI','MST_HT','MST_SD_S2','MST_SD_S2_LDI'};
% Model names
List_Name0={'Item Limit', 'Standard Mixture', 'Equal Precision', 'Slots-plus-Averaging',...
    ...
    'Signal Detection', 'Pure Guess', 'Signal Detection (ROC)','Threshold (ROC)', 'EVSD3','EVSD_LDI','MST_HT','MST_SD_S2','MST_SD_S2_LDI'};
